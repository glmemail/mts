...
class MessagelistController extends AdminController
{
    /**
    ...
    {
        $grid = new Grid(new Message_list());
    ...
    {
        // $show = new Show(Message_list::findOrFail($id));

        // $show->field('id', __('Id'));
        // $show->field('actiontime', __('Actiontime'));
        // $show->field('sysid', __('Sysid'));
        // $show->field('svrid', __('Svrid'));
        // $show->field('subsysid', __('Subsysid'));
        // $show->field('cmpid', __('Cmpid'));
    ...
    {
        $form = new Form(new Message_list());

        $form->datetime('actiontime', __('Actiontime'))->default(date('Y-m-d H:i:s'));
        $form->text('sysid', __('Sysid'));
        $form->text('svrid', __('Svrid'));
        $form->text('subsysid', __('Subsysid'));
        $form->text('cmpid', __('Cmpid'));
